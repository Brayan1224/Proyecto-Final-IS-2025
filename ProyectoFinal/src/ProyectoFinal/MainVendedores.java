...
public class MainVendedores extends javax.swing.JFrame{
    ...
    public MainVendedores() {
        ...
        SetImageLabel(jLabel2,"src\\imagenes\\slogan.png");
        SetImageLabel(jLabel3,"src\\imagenes\\mandala.png");
        SetImageButton(jButton3,"src\\imagenes\\opcionrepartidores.png");
        SetImageButton(jButton4,"src\\imagenes\\opcionpedido.png");
        SetImageButton(jButton5,"src\\imagenes\\cerrarsesion.png");
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        RutasVendedor newframe = new RutasVendedor();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        PedidosVendedor newframe = new PedidosVendedor();
        newframe.setVisible(true);
        //this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainVendedores().setVisible(true);
            }
        });
