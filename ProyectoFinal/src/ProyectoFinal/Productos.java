...
public class Productos extends javax.swing.JFrame {
    ...
    public void mostrar(String filtros){
        ...
        try{
            try (Statement stmt = p.conexion.createStatement()) {
                String consulta = "select ID_producto, descripcion_producto, piezas_disponibles, precio from productos "+ filtros;
                try (ResultSet rs = stmt.executeQuery(consulta)) {
                    while (rs.next()) {
                        datos[0] = rs.getString("ID_producto");
                        datos[1] = rs.getString("descripcion_producto");
                        datos[2] = rs.getString("piezas_disponibles");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String filtro = " where descripcion_producto like '%" + nombre + "%'";
        mostrar(filtro);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            int idp = Integer.parseInt((String)jTextField2.getText());
            int cantidad = Integer.parseInt((String)jTextField3.getText());
            CProductos p = new CProductos();
            p.capturar_id_producto(idp);
            p.entrada(cantidad);
