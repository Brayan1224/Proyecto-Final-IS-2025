...
public class PedidosCliente extends javax.swing.JFrame {
    ...
    public PedidosCliente(int ncliente) {
        R_usuario = ncliente;
        initComponents();
        ...
        mostrar(" where R_usuario = "+R_usuario);
    }
    ...
    private void initComponents() {
        ...
        jButtonHacerPedido.setBackground(new java.awt.Color(204, 204, 255));
        jButtonHacerPedido.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jButtonHacerPedido.setText("Hacer Pedido");
        jButtonHacerPedido.setActionCommand("← Regresar");
        jButtonHacerPedido.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jButtonHacerPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String filtro = " where R_usuario = "+R_usuario;
    ...
    private void jButtonHacerPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHacerPedidoActionPerformed
        ...
        try{
            try (Statement stmt = c.conexion.createStatement()) {
                String consulta = "select ID_cliente from clientes where R_usuario = "+R_usuario;
                try (ResultSet rs = stmt.executeQuery(consulta)) {
                    if (rs.next()) {
                        id_cliente = rs.getInt("ID_cliente");
                        System.out.println("ID cliente encontrado: " + id_cliente);
                    } else {
                        System.out.println("No se encontró cliente asociado");
                    }
                }
            }
        }catch(SQLException e){
        ...
        HacerPedido newframe = new HacerPedido(id_cliente);
